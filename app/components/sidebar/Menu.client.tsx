      ...
      >
        <div className="h-12 flex items-center justify-between px-4 border-b border-bolt-elements-borderColor bg-bolt-elements-background-depth-2 rounded-tr-2xl">
          ...
          <div className="flex items-center gap-3">
            <HelpButton onClick={() => window.open('https://www.vibelock.in', '_blank')} />
              ...
              <button
                ...
                className={classNames(
                  ...
                  selectionMode
                    ...
                    : 'bg-bolt-elements-background-depth-3 text-bolt-elements-textSecondary hover:bg-bolt-elements-item-backgroundActive border border-bolt-elements-borderColor',
                )}
